...
apply Upper_downward_stable with (B := B); auto with v62.
elim H'2; auto with v62.
Qed.
...
apply Lub_is_in_Carrier with (X := C); auto with v62.
apply Upper_Bound_Couple_intro; auto with v62.
apply Lub_is_in_Carrier with (X := C); auto with v62.
apply Lub_monotonic with (A := A) (B := C); auto with v62.
apply Lub_monotonic with (A := B) (B := C); auto with v62.
Qed.
...
intros x H'17; apply RoT with (y := a); auto with v62.
intros x H'17; apply RoT with (y := b); auto with v62.
Qed.
...
apply Lub_definition; auto with v62.
apply Upper_Bound_definition; auto with v62.
intros y H'13; elim H'13.
intros x H'30; apply RoT with (y := a); auto with v62.
intros x H'30; apply RoT with (y := b); auto with v62.
intros y H'13; try assumption.
apply H'4.
elim H'13; auto 7 with v62.
Qed.
...
apply LUaux with (A := A) (B := B); auto with v62.
Qed.
...
elim (H'0 x); auto with v62.
intros c H'1 H'2.
elim (H'0 y); auto with v62.
intros c' H'3 H'4.
elim H'.
intro H'5; elim (H'5 (Couple U c c')); auto with v62.
2: elim H'1; elim H'3; exists z; auto with v62.
intros bsup H'6; elim H'6.
intros H'7 H'8; exists bsup; split; auto with v62.
apply Defn_of_Approximant; auto with v62.
apply Definition_of_compact.
apply Lub_is_in_Carrier with (X := Couple U c c'); auto with v62.
intros X H'9 H'10.
elim H'1.
...
elim (Bottom_is_compact U D);
 ...
 auto with v62.
exists bot; split; auto with v62; auto with v62.
apply Lub_definition; auto with v62.
intros y H'1; elim H'1; auto with v62.
intros A H'1 H'2 x0 H'3.
cut (forall x : U, Union U A (Singleton U x) = Add U A x); auto with v62.
...
lapply Lub_of_Union;
 [ intro H'2; lapply (H'2 A (Singleton U x0));
    ...
    | idtac ]
 | idtac ]; auto with v62.
exists bsup0; split; [ assumption | auto with v62 ].
...
lapply (Lub_is_unique U D);
 ...
 auto with v62.
red in |- *; simpl in |- *.
intros x1 H'8; elim H'8; auto with v62.
elim H'7; auto with v62.
apply Singleton_has_lub.
lapply (H'4 x0); [ intro H'8; elim H'8 | idtac ]; auto with v62.
apply Upper_Bound_definition; auto with v62.
intros y H'5; try assumption.
lapply (H'4 y); [ intro H'10; elim H'10 | idtac ]; auto with v62.
red in |- *; simpl in |- *.
intros x1 H'5; try assumption.
lapply (H'4 x1); [ intro H'9; elim H'9 | idtac ]; auto with v62.
Qed.
...
Proof.
intros H' x H'0; constructor 1; auto with v62.
red in |- *; simpl in |- *; intros x0 H'1; elim H'1; auto with v62.
elim (Bottom_is_compact U D); auto with v62.
intros bot H'1; elim H'1; intros H'2 H'3; clear H'1.
apply Inhabited_intro with (x := bot); auto with v62.
apply Defn_of_Approximants; auto with v62.
elim H'2; auto with v62.
intros x1 x2 H'1; red in H'1; auto with v62.
...
intros H'10 H'13; exists x0; split; auto with v62.
elim H'12; auto with v62.
red in |- *; simpl in |- *.
intros x0 H'10; elim H'10; auto with v62.
red in |- *; simpl in |- *.
intros H'8 H'9; exists x; auto with v62.
Qed.
...
Proof.
intros H' x y H'0 H'1 H'2; try assumption; auto with v62.
red in H'; elim H'; intros H'3 H'4; clear H'; red in H'4.
elim H'4; intros H' H'5; clear H'4; red in H'; auto with v62.
...
generalize (H' y); intro h; elim h; intros H'6 H'9; clear h; try exact H'9;
 auto with v62.
apply Upper_downward_stable with (Approximants U D y); auto with v62.
red in |- *; (intros x0 H'10; elim H'10); auto with v62.
red in |- *; (intros x0 H'10; elim H'10); auto with v62.
apply Upper_Bound_definition; auto with v62.
intros y0 H'10; elim H'10; auto with v62.
Qed.
...
apply Defn_of_Approximants; auto with v62.
apply RoT with (y := x); auto with v62.
Qed.
...
intro H'3; elim H'3.
generalize (Rel_of_antisymmetric U D); auto with v62.
rewrite H'2; auto with v62.
Qed.
...
elim
 (Strict_super_set_contains_new_element U (Approximants U D x)
    (Approximants U D y)); auto 8 with v62.
...
split; [ idtac | split; [ try assumption | idtac ] ]; auto with v62.
elim H'13; auto with v62.
elim H'11; auto with v62.
red in |- *; simpl in |- *; intro H'15; try exact H'15.
apply H'7.
rewrite H'15; auto with v62.
elim (Upper_Bound_Couple_inv U D x c x1);
 [ intros H'21 H'22; elim H'22; intros H'23 H'24; try exact H'23; clear H'22
 | idtac ]; auto with v62.
red in |- *; simpl in |- *.
intros x1 H'11; elim H'11; auto with v62.
