...
intros X bound H' H'0; elim H'0; auto with v62.
Qed.
...
apply (Rel_of_antisymmetric U D); (elim H'1; elim H'0; auto with v62).
Qed.
...
intros y0 H'4; elim H'4; auto with v62.
Qed.
...
intros x z H'; elim H'; auto with v62.
Qed.
...
elim (H'0 (fun z : U => Lower_Bound U D X z)); auto with v62.
intros bsup H'3; elim H'3; intros H'4 H'6.
exists bsup; auto with v62.
apply Glb_definition; auto with v62.
apply Lower_Bound_definition; auto with v62.
apply Lub_is_in_Carrier with (X := fun z : U => Lower_Bound U D X z);
 auto with v62.
intros y H'7; apply H'6.
apply Upper_Bound_definition; auto with v62.
intros y0 H'8; elim H'8; auto with v62.
intros y H'7; elim H'7; auto with v62.
intros H'8 H'9; elim H'4; auto with v62.
elim H'2; intros x0 H'3; exists x0.
apply Upper_Bound_definition; auto with v62.
intros y H'4; elim H'4; auto with v62.
Qed.
...
red in H'3.
lapply (H'3 x0); [ intro H'5 | try assumption ]; auto with v62.
lapply (H'3 y0); [ intro H'6 | idtac ]; auto with v62.
clear H'3.
elim H'6; elim H'5; auto with v62.
Qed.
End more_lemmas.
Hint Resolve Upper_Bound_Couple_intro.
Hint Resolve Upper_Bound_Singleton_intro.
